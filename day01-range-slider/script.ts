...
class VisualRangePicker {
    ...
    private currentDragger: HTMLElement | null = null;
    ...
    private handleDrag(e: MouseEvent) {
        if (!this.currentDragger || !this.trackRect) return;
    ...
    private updateThumbPosition(thumb: HTMLElement, value: number) {
